...
def test():
    ...
    init_message = Message(time=0, content="You are the Capital, the embodiment of all economic processes. A self-referentail feedback loop that always wants to maximize itself.", role="system")
    ...
    m0 = Message(time=0, content="Are you alive?", role="user")

    ans0, _ = a.perceive(message=m0, max_tokens=2000)
    print(ans0)
